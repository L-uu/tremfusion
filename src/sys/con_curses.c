...
void CON_Init(void)
{
	...
	if (!curses_on) {
		...
		if (has_colors()) {
			...
			init_pair(9, COLOR_GRAY, -1);
			init_pair(10, COLOR_ORANGE, -1);
			init_pair(11, COLOR_ROSE_BUD, -1);
			init_pair(12, COLOR_PALE_GREEN, -1);
			init_pair(13, COLOR_PALE_GOLDEN, -1);
			init_pair(14, COLOR_COLUMBIA_BLUE, -1);
			init_pair(15, COLOR_PALE_TURQUOISE, -1);
			init_pair(16, COLOR_PALE_VIOLET_RED, -1);
			init_pair(17, COLOR_PALACE_PALE_WHITE, -1);
			init_pair(18, COLOR_OLIVE, -1);
			init_pair(19, COLOR_TOMATO, -1);
			init_pair(20, COLOR_LIME, -1);
			init_pair(21, COLOR_LEMON, -1);
			init_pair(22, COLOR_BLUE_BERRY, -1);
			init_pair(23, COLOR_TURQUOISE, -1);
			init_pair(24, COLOR_WILD_WATERMELON, -1);
			init_pair(25, COLOR_SALTPAN, -1);
			init_pair(26, COLOR_GRAY_CHATEAU, -1);
			init_pair(27, COLOR_RUST, -1);
			init_pair(28, COLOR_COPPER_GREEN, -1);
			init_pair(29, COLOR_GOLD, -1);
			init_pair(30, COLOR_STEEL_BLUE, -1);
			init_pair(31, COLOR_STEEL_GRAY, -1);
			init_pair(32, COLOR_BRONZE, -1);
			init_pair(33, COLOR_SILVER, -1);
			init_pair(34, COLOR_DARK_GRAY, -1);
			init_pair(35, COLOR_DARK_ORANGE, -1);
			init_pair(36, COLOR_DARK_GREEN, -1);
			init_pair(37, COLOR_RED_ORANGE, -1);
			init_pair(38, COLOR_FOREST_GREEN, -1);
			init_pair(39, COLOR_BRIGHT_SUN, -1);
			init_pair(40, COLOR_MEDIUM_SLATE_BLUE, -1);
			init_pair(41, COLOR_CELESTE, -1);
			init_pair(42, COLOR_IRONSTONE, -1);
			init_pair(43, COLOR_TIMBERWOLF, -1);
			init_pair(44, COLOR_ONYX, -1);
			init_pair(45, COLOR_ROSEWOOD, -1);
			init_pair(46, COLOR_KOKODA, -1);
			init_pair(47, COLOR_PORSCHE, -1);
			init_pair(48, COLOR_CLOUD_BURST, -1);
			init_pair(49, COLOR_BLUE_DIANE, -1);
			init_pair(50, COLOR_ROPE, -1);
			init_pair(51, COLOR_BLONDE, -1);
			init_pair(52, COLOR_SMOKEY_BLACK, -1);
			init_pair(53, COLOR_AMERICAN_ROSE, -1);
			init_pair(54, COLOR_NEON_GREEN, -1);
			init_pair(55, COLOR_NEON_YELLOW, -1);
			init_pair(56, COLOR_ULTRAMARINE, -1);
			init_pair(57, COLOR_TURQUOISE_BLUE, -1);
			init_pair(58, COLOR_DARK_MAGENTA, -1);
			init_pair(59, COLOR_MAGIC_MINT, -1);
			init_pair(60, COLOR_LIGHT_GRAY, -1);
			init_pair(61, COLOR_LIGHT_SALMON, -1);
			init_pair(62, COLOR_LIGHT_GREEN, -1);
		}
